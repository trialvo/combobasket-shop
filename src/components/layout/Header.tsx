...
const Header = () => {
  ...
  const menuItems = [
    ...
    },
    {
      icon: Package,
      title: "All Products",
      description: "Browse combo products",
      link: "/products"
    },
    {
      icon: Mail,
      ...
      <div className="container mx-auto py-3 px-4">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex-1 max-w-xl hidden md:block">
            <SearchAutocomplete placeholder="Search combo products..." />
          </div>
            ...
            <Sheet>
              ...
              <SheetContent side="left" className="w-[85%] max-w-sm p-0 flex flex-col">
                ...
                <div className="flex-shrink-0 p-4 border-t bg-background mt-auto">
                  ...
                  <p className="text-center text-sm text-muted-foreground mt-2">24/7 Customer Support</p>
                </div>
              </SheetContent>
            </Sheet>
